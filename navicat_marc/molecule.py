...
def test_compare_origin(path="navicat_marc/test_files/"):
    chunk_a = [
        "19",
...
def test_molecule_from_file(path="navicat_marc/test_files/"):
    filenames = [
        "L-Valine.xyz",
        "Benzaldehyde.xyz",
        "Ferrocene.xyz",
...
def test_molecule_to_file(path="navicat_marc/test_files/"):
    filenames = [
        "L-Valine.xyz",
        "Benzaldehyde.xyz",
        "Ferrocene.xyz",
